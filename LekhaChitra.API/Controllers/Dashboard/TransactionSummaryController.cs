...
using LekhaChitra.Application.Features.Dashboard.Query.GetTransactionSummary;
using MediatR;
...
namespace LekhaChitra.API.Controllers.Dashboard
{
    ...
    public class TransactionSummaryController : ControllerBase
    {
        ...
        public TransactionSummaryController(IMediator mediator)
        {
            _mediator = mediator;
        }
                                                            ...
                                                            CancellationToken ct = default)
        {
            ...
            var result = await _mediator.Send(new GetTransactionSummaryQuery(fromDate, toDate), ct);
